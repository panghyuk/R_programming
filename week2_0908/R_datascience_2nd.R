...
sd(netflix$IMDB.Score)

plot(telecom$T, telecom$VZ)

plot(netflix$IMDB.Score,netflix$Runtime)

hist(state[['Population']], breaks = breaks)


hist(netflix$IMDB.Score, freq = FALSE)
lines(density(netflix$IMDB.Score), lwd = 3, col = 'blue')
